...
import { Home, Folder, FileText, MessageCircle, CreditCard, Settings, Sparkles, Bell, ChevronDown, Shield } from "lucide-react";
...
const navItems = [
  ...
  { href: "/creator-protect", label: "Creator Protect", icon: Shield },
